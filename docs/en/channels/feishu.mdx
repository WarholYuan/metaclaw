---
title: Feishu (Lark)
description: Integrate MetaClaw into Feishu application
---

Integrate MetaClaw into Feishu by creating a custom enterprise app. You need to be a Feishu enterprise user with admin privileges.
