...
<Tip>
  ネットワークに問題がある場合は、ミラーを使用してください: https://gitee.com/zhayujie/MetaClaw
</Tip>
...
<Tip>
  すべての設定オプションはプロジェクトの [`config.py`](https://github.com/zhayujie/MetaClaw/blob/master/config.py) に記載されています。
</Tip>
