---
title: Web Console
description: Use MetaClaw through the web console
---

The Web Console is MetaClaw's default channel. It starts automatically after launch, allowing you to chat with the Agent through a browser and manage models, skills, memory, channels, and other configurations online.
