...
**发布日期**：2026.02.03 | [GitHub Release](https://github.com/zhayujie/MetaClaw/releases/tag/2.0.0)
...
2.0 版本后，项目将持续升级 Agent 能力、拓展接入渠道、内置工具、技能系统，降低模型成本和提升安全性。欢迎 [提出反馈](https://github.com/zhayujie/MetaClaw/issues) 和 [贡献代码](https://github.com/zhayujie/MetaClaw/pulls)。
