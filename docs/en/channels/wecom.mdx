---
title: WeCom
description: Integrate MetaClaw into WeCom enterprise app
---

Integrate MetaClaw into WeCom through a custom enterprise app, supporting one-on-one chat for internal employees.
