---
title: DingTalk
description: Integrate MetaClaw into DingTalk application
---

Integrate MetaClaw into DingTalk by creating an intelligent robot app on the DingTalk Open Platform.
