...
<Tip>
  For network issues, use the mirror: https://gitee.com/zhayujie/MetaClaw
</Tip>
...
<Tip>
  Full configuration options are in the project [`config.py`](https://github.com/zhayujie/MetaClaw/blob/master/config.py).
</Tip>
