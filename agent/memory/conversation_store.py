...
Storage path: ~/metaclaw/sessions/conversations.db
"""
...
def get_conversation_store() -> ConversationStore:
    ...
    SQLite file: ~/metaclaw/memory/long-term/index.db
    ...
    with _store_lock:
        ...
        try:
            ...
            db_path = Path(expand_path(DEFAULT_AGENT_WORKSPACE)) / "memory" / "long-term" / "index.db"
