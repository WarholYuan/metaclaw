...
- **Custom skills:** Created by users through conversation, stored in the workspace (`~/metaclaw/skills/`), capable of implementing any complex business process or third-party integration.
